...
const PutAppointment = ({ onAppointmentAdded = () => {}}) => {
    ...
    useEffect(() => {
        const filteredVehicles = vehicles.filter(vehicle => {
            if (editAppointment.personClient) {
                if (vehicle.personClient && vehicle.personClient._id === editAppointment.personClient) {
                    return vehicle.licensePlate.toLowerCase().includes(searchTermVehicles.toLowerCase());
                }
            } else if (editAppointment.companyClient) {
                if (vehicle.companyClient && vehicle.companyClient._id === editAppointment.companyClient) {
                    return vehicle.licensePlate.toLowerCase().includes(searchTermVehicles.toLowerCase());
                }
            } else {
                return vehicle.licensePlate.toLowerCase().includes(searchTermVehicles.toLowerCase());
    ...
    }, [searchTermVehicles, vehicles, editAppointment.personClient, editAppointment.companyClient]);
